...
5. Install the item into `Examples/Showcase` and compile it at the deployment floor
6. Add dependency-resolution and search coverage when introducing a new item
7. Review the regular and accessibility-size states before changing a visual reference
