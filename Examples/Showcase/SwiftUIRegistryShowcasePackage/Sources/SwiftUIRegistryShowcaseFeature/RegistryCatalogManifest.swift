...
enum RegistryCatalogManifest {
    static let entries: [CatalogEntry] = [
        ...
        CatalogEntry(
            ...
            usage: "PreviewWall02()",
            dependencies: ["card", "field", "input", "button", "item", "badge", "separator", "chart", "input-group", "toggle-group", "empty", "accordion", "skeleton", "checkbox", "breadcrumb", "select", "textarea", "progress", "table", "combobox"],
            tags: ["preview", "theme", "showcase", "cards", "create", "shadcn", "dashboard"]
        ),
        CatalogEntry(
            name: "progress",
