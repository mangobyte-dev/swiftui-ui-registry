...
3. argent 0.22.1 cannot drive the Xcode 27 beta simulators (its simulator-server fails to load SimulatorKit); 0.24.0 is available and was not installed. XcodeBuildMCP's UI automation works on the pinned iPhone 17
