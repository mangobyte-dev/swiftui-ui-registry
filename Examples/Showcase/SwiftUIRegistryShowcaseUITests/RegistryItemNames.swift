...
enum RegistryItemNames {
    static let components: [String] = ["accordion", "alert", "avatar", "badge", "breadcrumb", "button", "button-group", "card", "checkbox", "combobox", "command", "empty", "field", "input", "input-group", "item", "kbd", "label", "macro-progress", "metric-card", "progress", "select", "separator", "skeleton", "spinner", "table", "textarea", "toggle", "toggle-group", "transaction-row"]
